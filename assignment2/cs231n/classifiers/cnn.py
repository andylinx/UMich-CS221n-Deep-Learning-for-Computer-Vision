...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out, cache_fc2 = affine_relu_forward(out, W2, b2)
        scores, cache_fc3 = affine_forward(out, W3, b3)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dout, cache_fc3)
        grads['W3'] += self.reg * W3
        dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, cache_fc2)
